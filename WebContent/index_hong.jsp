								...
								<div class="row gtr-uniform">
									...
									<div class="col-4 col-12-small">
										<input type="radio" id="demo-priority-low"
											...
											for="demo-priority-low">남</label>
									</div>
									<div class="col-4 col-12-small">
										<input type="radio" id="demo-priority-normal"
											name="demo-priority"> <label
											for="demo-priority-normal">여</label>
									</div>

									<!-- Break -->
									<div class="col-12">
										<textarea name="demo-message" id="demo-message"
											placeholder="Enter your message" rows="6" readonly="readonly">시행일자 : 2020년 05월 19일

제1조 (목적)
본 약관은 김휘준 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
부칙 (시행일)
본 약관은 2020년 5월 19일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.</textarea>
									</div>
									<!-- Break -->
									<div class="col-6 col-12-small">
										<input type="checkbox" id="demo-copy" name="demo-copy">
										<label for="demo-copy">동의 합니다.</label>
									</div>
									<!-- Break -->
									<div class="col-12">
										<ul class="actions">
						...
						<div id="login" class="modal">
							<form method="post" action="#">
								<div class="fields">
									<div class="col-6 col-12-xsmall" style="margin: 0 auto;">
										<label for="name">EMAIL</label> <input type="text" name="id"
											id="id" />
									</div>
									<br>
								</div>
								<div class="fields">
									<div class="col-6 col-12-xsmall"
										style="margin-left: auto; margin-right: auto; line-height: 250%">
										<label for="email">PASSWORD</label> <input type="password"
											name="login_pw" id="login_pw" /> <sup
											style="font-size: 0.6em;">아이디 또는 비밀번호 찾기</sup>
									</div>
								</div>
								<ul class="actions" style="display: table; margin: 0 auto">
									<li style="display: inline-block;"><input type="reset"
										value="LOGIN" /></li>
								</ul>
							</form>
						</div>
					...
					<footer>
						<a id="recom_sc" href="#banner" class="start scrolly">인기 여행일정</a>
						<a id="recom_sc" href="#recom_city" class="start scrolly">추천도시</a>
					</footer>
				</div>
				<!-- Nav -->
				<nav id="nav">
					<ul>
						<li><a href="left-sidebar.html">일정 만들기</a></li>
						<li><a href="right-sidebar.html">일정 보기</a></li>
						<li><a href="no-sidebar.html">여행기</a></li>
					</ul>
					<div id="nav2">
						<ul id="sign">
							<li><a href="#asdf" class="button small " rel="modal:open">회원가입</a></li>
							<li><a href="#login" class="button small" rel="modal:open">로그인</a></li>
							<li><a href="#" class="button primary small"
								style="display: none;">내정보</a>
								<ul>
									<li><a href="#">내일정 보기</a></li>
									<li><a href="#">여행기</a></li>
									<li><a href="#">동행신청</a></li>
									<li><a href="#">로그아웃</a></li>
								</ul></li>
					...
					<div class="reel">
						...
						<article>
							<a href="#" class="image featured"><img
								src="images/contents1.jpg" alt="" /></a>
							<header>
								<h3>
